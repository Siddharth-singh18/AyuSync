      ...
      <div className="flex justify-between items-start mb-4">
        <div>
          <h3 className="text-lg font-bold flex items-center gap-2">
            ...
            <span className="text-xs px-2 py-0.5 rounded-full border bg-muted font-normal text-muted-foreground">
              Beta
            </span>
          </h3>
          <p className="text-sm text-muted-foreground mt-1">Generated by {provenanceModel}</p>
        </div>
